...
local names = { BuyFood="RemoteFunction", GetData="RemoteFunction", Collect="RemoteFunction",
	...
	StartMinigame="RemoteEvent", MinigameResult="RemoteEvent", Notify="RemoteEvent", HireStaff="RemoteFunction", UpgradeStation="RemoteFunction", ClaimQuest="RemoteFunction", OpenCook="RemoteEvent", PickCook="RemoteEvent", Decor="RemoteFunction" }
local folder
if isServer then
