	...
	task.spawn(function()
		while true do
			...
			pcall(function()
				...
				local night = (n.hour < 6 or n.hour > 18)
				Lighting.Ambient = night and Color3.fromRGB(95, 100, 125) or Color3.fromRGB(120, 125, 140)
				Lighting.OutdoorAmbient = night and Color3.fromRGB(105, 110, 140) or Color3.fromRGB(140, 145, 160)
